...
class DetectionFailure(str, Enum):
    ...
    NO_WHITE_CANDIDATE = "NO_WHITE_CANDIDATE"
    WHITE_OCCUPANCY_LOW = "WHITE_OCCUPANCY_LOW"
    A4_GEOMETRY_INVALID = "A4_GEOMETRY_INVALID"
    RING_RATIO_INVALID = "RING_RATIO_INVALID"
    RING_CENTER_INCONSISTENT = "RING_CENTER_INCONSISTENT"
    PARTIAL_HISTORY_REQUIRED = "PARTIAL_HISTORY_REQUIRED"
    SINGLE_ARC_LIMIT = "SINGLE_ARC_LIMIT"
    EXCESSIVE_SCALE_JUMP = "EXCESSIVE_SCALE_JUMP"
